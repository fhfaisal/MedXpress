...
class ProductBodySection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Card(
      shape: const RoundedRectangleBorder(borderRadius: BorderRadius.all(Radius.circular(AppSizes.borderRadiusXXL))),
      child: Container(
        ...
        decoration: BoxDecoration(
            ...
            border: Border.symmetric(horizontal: BorderSide(color: AppColors.primary10))),
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  children: [
                    Text('\$${product.oldPrice}',
                        style: Theme.of(context)
                            .textTheme
                            .bodySmall!
                            .copyWith(fontWeight: FontWeight.w600, decoration: TextDecoration.lineThrough)),
          ...
          Row(children: [
            ...
            const Icon(Icons.star_half, color: Colors.amber, size: AppSizes.iconMd),
            const SizedBox(width: AppSizes.spaceBtwItems4),
            Flexible(
              child: Text(
